...
In 2001 and 2002, the California Department of Water Resources (DWR) conducted snorkel surveys between March and August at 29 sampling locations in the Feather River (13 in the Low Flow Channel, 16 in the High Flow Channel). Sections within the survey location were chosen at random and surveyed monthly. Survey sections covered an area of 25 meters long and four meters wide and ran parallel to one riverbank. Two divers surveyed the survey section by swimming upstream and marking the location of fish observations and the number, species and size of the fish observed. The divers would then measure water depth, average velocity, substrate, cover, and habitat types at 36 points (e.g. the microhabitat unit), each representing one square meter within the survey section. The divers also returned to the locations where fish were observed and measured depth and focal velocity associated with each fish observation. Water temperature was continuously monitored through a network of StowAway electronic thermistors. 

![Figure 2. Diagram of the mini snorkel data collection design](minisnork_methods_figure_02112025.jpg)
...
- **Location Table ID or survey section** refers to the specific section within the location that was snorkeled representing 25 meters by 4 meters. Each location was surveyed once a month during the survey and the specific section was chosen at random and may or may not be the same between months. 
- **Transect Code or microhabitat unit** refers to the 1m by 1m microhabit unit within the survey section (e.g. location table ID). For each survey section there are 36 microhabitat units where the lowest ID numbers mean upstream and the highest mean downstream.
