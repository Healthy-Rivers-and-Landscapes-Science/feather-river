...
### Feather River locations are ordered from the most upstream (closest to Oroville Dam) to the most downstream. Percent cover is averaged across all microhabitat plots within each location. See the Map Filter or Attribute Filter for more detailed summaries of habitat by microhabitat.
...
renderPlot({
  ...
  labs(
    x = "",   
    y = "",
    caption = "Undercut bank was removed because this cover type only occurs at the margins and therefore cannot be compared with other cover types when summarizing at the location level."
  ) +
  theme_minimal() +
  theme(
