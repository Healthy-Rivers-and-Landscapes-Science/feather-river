...
```{r}
# TODO add a default because when open the heat map is empty. Maybe it prints "click a point on the map" when empty?
...
```{r}
# TODO add a zoom to point functionality based on the location_id input
