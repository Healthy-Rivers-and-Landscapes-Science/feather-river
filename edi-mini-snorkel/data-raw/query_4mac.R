...
mini_snork_db <- here::here("edi-mini-snorkel", "data-raw", "databases",  "MiniSnorkelDTB.mdb")
mdb.get(mini_snork_db, tables = T)

ck_db <- here::here("edi-mini-snorkel","data-raw", "databases",  "FR_S_and_S_Tables.mdb")
mdb.get(ck_db, tables = T)

snork_micro <- mdb.get(ck_db, tables = "SnorkMicrohabitat")
write_csv(snork_micro, here::here("edi-mini-snorkel", "data-raw", "databases", "SnorkMicrohabitat.csv"))
snork <- mdb.get(ck_db, tables = "SnorkObservationsTBL")
# tables
all_fish_obs <- mdb.get(mini_snork_db, tables = "All fish observations") |> glimpse()
write_csv(all_fish_obs, here::here("edi-mini-snorkel","data-raw", "database-tables", "all_fish_obs.csv"))
all_fish_obs <- read_csv(here::here("edi-mini-snorkel", "data-raw", "database-tables", "all_fish_obs.csv")) |> glimpse()
...
write_csv(location_table, here::here("edi-mini-snorkel", "data-raw", "database-tables", "location_table.csv"))
location_table <- read_csv(here::here("edi-mini-snorkel", "data-raw", "database-tables", "location_table.csv")) |> glimpse()
...
write_csv(fish_data, here::here("edi-mini-snorkel", "data-raw", "database-tables", "fish_data.csv"))

fish_data <- read_csv(here::here("edi-mini-snorkel", "data-raw", "database-tables", "fish_data.csv")) |> glimpse()
...
write_csv(canopy_cover, here::here("edi-mini-snorkel", "data-raw", "database-tables", "canopy_cover_db_table.csv"))
...
library(Hmisc)
seine_db <- here::here("edi-mini-snorkel", "data-raw", "databases",  "FR_S_and_S_Oroville.mdb")
...
mini_snork_db_2002 <- here::here("edi-mini-snorkel", "data-raw", "databases",  "minisnorkdb3.mdb")
