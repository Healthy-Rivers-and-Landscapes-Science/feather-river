...
```{r, include=FALSE}
# redd survey points
redd_data <- read.csv("edi-redd/data-raw/combined_raw_data.csv")
...
fixed_zeros <- read.csv("edi-redd/data-raw/qc-processing-files/Faulty_lat_long_records_edits_Chris_111224.csv") |> # csv with Chris' notes
  select(-1) |> 
...
fixed_off_channel <- read.csv("edi-redd/data-raw/qc-processing-files/Off_channel_records_edit_Chris_110524.csv") |> 
  glimpse()
