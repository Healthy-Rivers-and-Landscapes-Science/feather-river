...
ongoing_snorkel <- read_csv(here::here("edi-ongoing-snorkel", "data", "fish_observations.csv"))
ongoing_snorkel_metadata <- read_csv(here::here("edi-ongoing-snorkel", "data", "survey_characteristics.csv"))
ongoing_snorkel_location <- read_csv(here::here("edi-ongoing-snorkel", "data", "locations_lookup.csv"))
# mini snorkel data
mini_snorkel_raw <- read_csv(here::here("mini-snorkel-analysis", "data-raw", "microhabitat_observations.csv")) |>
  mutate(fish_presence = factor(ifelse(count == 0 | is.na(count), 0, 1)))
location_raw <- read_csv(here::here("mini-snorkel-analysis", "data-raw", "survey_locations.csv"))
```
...
ggsave(here::here("mini-snorkel-analysis", "analysis", "figures", "environmental_boxplot.png"), height = 7, width = 9)
...
ggsave(here::here("mini-snorkel-analysis", "analysis", "figures", "substrate_boxplot.png"), height = 7, width = 9)
...
ggsave(here::here("mini-snorkel-analysis", "analysis", "figures", "cover_boxplot.png"), height = 7, width = 9)
...
ggsave(here::here("mini-snorkel-analysis", "analysis", "figures", "cover_no_fish_obs_boxplot.png"), height = 7, width = 9)
```
...
substrate_cluster_assign |> 
  ...
  labs(x = "",
       y = "")
ggsave(here::here("mini-snorkel-analysis", "analysis", "figures", "substrate_cluster_combo.png"), height = 7, width = 9)
# cluster_assign |> 
#   ggplot(aes(x = cluster_groups, y = percent_small_gravel_substrate)) +
#   geom_boxplot()
# cluster_assign |> 
...
ongoing_snorkel_obs <- read_csv(here::here("mini-snorkel-analysis", "data-raw", "cleaner_snorkel_observations.csv"))
ongoing_snorkel_metadata <- read_csv(here::here("mini-snorkel-analysis", "data-raw", "cleaner_snorkel_metadata.csv"))
site_lookup <- read_csv(here::here("mini-snorkel-analysis", "data-raw", "location_unit_lookup.csv"))
