...
ongoing_snorkel <- read_csv(here::here("mini-snorkel-analysis", "data-raw", "ongoing_fish_observations.csv"))
ongoing_snorkel_metadata <- read_csv(here::here("mini-snorkel-analysis", "data-raw", "ongoing_survey_characteristics.csv"))
ongoing_snorkel_location <- read_csv(here::here("mini-snorkel-analysis", "data-raw", "ongoing_locations_lookup.csv"))
