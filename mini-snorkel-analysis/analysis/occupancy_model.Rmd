...
ongoing_location_lookup_raw <- read_csv(here::here("data-raw", "feather_location_lookup.csv"))
ongoing_metadata_raw <- read_csv(here::here("data-raw", "feather_snorkel_metadata.csv"))
ongoing_obs_raw <- read_csv(here::here("data-raw", "feather_snorkel_observations.csv"))
