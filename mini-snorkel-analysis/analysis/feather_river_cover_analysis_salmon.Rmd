...
#   saveRDS(here::here("mini-snorkel-analysis", "visualizations", "raw_redd_location_chinook.rds"))
...
ggsave(
  filename = here::here("mini-snorkel-analysis", "figures", "chinook_hsi_lfc_hfc.png"),
  width = 12,
  height = 9,
  dpi = 300,
  bg = "white"
...
ggsave(
  filename = here::here("mini-snorkel-analysis", "figures", "chinook_hsi_locations_boxplot.png"),
  width = 12,
  height = 9,
  dpi = 300,
  bg = "white"
